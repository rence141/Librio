...
class ModelLoader {
  ...
  static const List<AiModel> availableModels = [
    ...
    AiModel(
      ...
      fileName: '',
      url: '',
      description: 'Online. Latest Gemini, fast & smart.',
      sizeLabel: 'Cloud',
      isOnline: true,
    ),
    AiModel(
      ...
      fileName: '',
      url: '',
      description: 'Online. Reliable, good reasoning.',
      sizeLabel: 'Cloud',
      isOnline: true,
    ),
    AiModel(
    ...
    AiModel(
      ...
      fileName: '',
      url: '',
      description: 'Online. Most capable GPT.',
      sizeLabel: 'Cloud',
      isOnline: true,
    ),
    AiModel(
      ...
      fileName: '',
      url: '',
      description: 'Online. Fast GPT, good value.',
      sizeLabel: 'Cloud',
      isOnline: true,
    ),
    AiModel(
      ...
      fileName: '',
      url: '',
      description: 'Online. Strong reasoning, coding.',
      sizeLabel: 'Cloud',
      isOnline: true,
    ),
    AiModel(
      ...
      fileName: '',
      url: '',
      description: 'Online. Massive coding model.',
      sizeLabel: 'Cloud',
      isOnline: true,
    ),
    AiModel(
      ...
      fileName: '',
      url: '',
      description: 'Online. Meta\'s latest large model.',
      sizeLabel: 'Cloud',
      isOnline: true,
    ),
    AiModel(
      ...
      fileName: '',
      url: '',
      description: 'Online. xAI\'s latest model.',
      sizeLabel: 'Cloud',
      isOnline: true,
    ),
  ];
